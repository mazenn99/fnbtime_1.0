...
jQuery(function($) {
	...
	// This function to switch in login and sign up in login page
	$('.login-page-form h1 span').click(function () {
		$(this).addClass('selected-form').siblings().removeClass('selected-form');
		$('.login-page-form form').hide();
	...
	*/
	...
	$(document).on('click', '.btn-ajax-login,.login-box-box-action a' ,function(){
		...
		setTimeout(function(){
			 $modal.load('ajax-login-modal-login.php.html', '', function(){
				$modal.modal();
			});
		}, 1000);
	});
	...
	$(document).on('click', '.btn-ajax-register,.register-box-box-action a' ,function(){
		...
		setTimeout(function(){
			 $modalRegister.load('ajax-login-modal-register.php', '', function(){
				$modalRegister.modal();
			});
		}, 1000);
	});
	...
	$(document).on('click', '.btn-ajax-forgot-password,.login-box-link-action a' ,function(){
		...
		setTimeout(function(){
			 ...
			 $modalForgotPassword.load('ajax-login-modal-forgot-password.php', '', function(){
...
function initSlider(){
	...
	// // This to add restaurant in favorite
    ...
    //             $("#favorite").html(response).prop('disabled' , true)
    //         }
    //     })
	// })
	// // This to add restaurant in favorite
	...
	// // This to filter cuisine type on restaurant.php page
	...
	// 			$("#filterTypeCuisineSearch").html(data)
	// 		}
	// 	})
	// });
	// // This to filter cuisine type on restaurant.php page
