  ...
  <div class="flex flex-col">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-32">
      <form
        ...
        method="POST"
        action="<?php echo e($model ? route("laratrust.{$type}s.update", $model->id) : route("laratrust.{$type}s.store")); ?>"
...
<?php echo $__env->make('laratrust::panel.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\vendor\santigarcor\laratrust\resources\views\panel\edit.blade.php ENDPATH**/ ?>