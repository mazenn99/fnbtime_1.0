                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            <a href="<?php echo e(route('dashboard-users')); ?>"><h2 class="number"><?php echo e(\App\User::count()); ?></h2>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fnbtime-LARAVEL-master\resources\views/admin/index.blade.php ENDPATH**/ ?>