                            ...
                            $.ajax({
                                ...
                                success:function (response) {
                                    ...
                                    for (i in response) {
                                      ...
                                      res+='<div class="reservation-summary-wrapper"> <a href="restaurant/'+response[i]['id']+'?restaurant='+response[i]['id']+'">       <ul class="reservation-summary-list">                                 <li>            <span class="block text-muted text-uppercase">Restaurant</span>             <h6>'+response[i]['name']+'</h6>            </li>                       <li>            <span class="block text-muted text-uppercase">Country</span>            <h6>'+response[i]['country']['couName'] +'</h6>             </li>                       <li>            <span class="block text-muted text-uppercase">city</span>           <h6>'+response[i]['city']['citName']+'</h6>             </li>       </ul> </a> </div>'; 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\resources\views\client\restaurant.blade.php ENDPATH**/ ?>