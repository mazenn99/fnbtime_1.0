<?php $__env->startSection('title' , 'Edit ' . Auth::user()->name); ?>
            ...
            <div class="col-lg-6">
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="<?php echo e(route('update-admin-info')); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\resources\views\admin\edit.blade.php ENDPATH**/ ?>