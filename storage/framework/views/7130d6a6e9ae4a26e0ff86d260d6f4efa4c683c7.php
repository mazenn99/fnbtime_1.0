            ...
            <div class="container-fluid">
                <div class="row">
                    <?php if(Auth::user()->is_admin == 1): ?>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item">
                                <a href="#"><h2 class="number"><?php echo e(\App\Model\ContractRestaurant::count()); ?></h2>
                                    <span class="desc">Contracts</span> <br>
                                    Approved : <?php echo e(\App\Model\ContractRestaurant::where('approve_at' , '!=' , 'NULL')->count()); ?> 
                                    <br>
                                    Not Approved : <?php echo e(\App\Model\ContractRestaurant::whereNull('approve_at')->count()); ?>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\resources\views\admin\index.blade.php ENDPATH**/ ?>