...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo e(asset('/vendor/laratrust/img/logo.png')); ?>">
  <title>Laratrust - <?php echo $__env->yieldContent('title'); ?></title>
  <link href="<?php echo e(asset(mix('laratrust.css', 'vendor/laratrust'))); ?>" rel="stylesheet">
...
</html><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\vendor\santigarcor\laratrust\resources\views\panel\layout.blade.php ENDPATH**/ ?>