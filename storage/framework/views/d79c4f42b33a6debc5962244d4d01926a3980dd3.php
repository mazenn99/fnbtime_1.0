                                ...
                                <div class="reservation-summary-wrapper">
                                    ...
                                    <ul class="reservation-summary-list">
                                        ...
                                        <li>
                                            ...
                                            <h6><?php echo e($result->restaurant->name); ?></h6>
                                        </li>
                                        
                                        <li>
                                            <span class="block text-muted text-uppercase">Reservation Name</span>
                                            <h6><?php echo e($result->name); ?></h6>
                                        </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\resources\views\client\client.blade.php ENDPATH**/ ?>