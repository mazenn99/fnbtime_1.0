          ...
          <tbody class="bg-white">
            ...
            <tr>
              ...
              <td class="flex justify-end px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                ...
                <a href="<?php echo e(route('laratrust.roles.edit', $role->id)); ?>" class="text-blue-600 hover:text-blue-900">Edit</a>
                <?php else: ?>
                <a href="<?php echo e(route('laratrust.roles.show', $role->id)); ?>" class="text-blue-600 hover:text-blue-900">Details</a>
                <?php endif; ?>
                <form
                  action="<?php echo e(route('laratrust.roles.destroy', $role->id)); ?>"
                  method="POST"
...
<?php echo $__env->make('laratrust::panel.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\fnbtime\fnbtime_1.0\vendor\santigarcor\laratrust\resources\views\panel\roles\index.blade.php ENDPATH**/ ?>