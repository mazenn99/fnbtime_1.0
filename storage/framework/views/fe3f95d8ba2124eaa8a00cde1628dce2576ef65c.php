                                        ...
                                        <div class="restaurant-grid-item">
                                            <a href="<?php echo e(route('res-info' , $restaurant->id)); ?>">
                                                <div
                                                    ...
                                                    <img src="<?php echo e(asset('images/res-images')); ?>/<?php echo $img[0] ?>"
                                                         alt="Image"/>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="process-item">
                                        ...
                                        <div class="process-inner">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="icon"><i
                                                        class="flaticon-restaurant-elements-placeholder"></i>
                                                </div>
                                    ...
                                    <div class="process-item">
                                        ...
                                        <div class="process-inner">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="icon"><i
                                                        class="flaticon-restaurant-elements-restaurant"></i>
                                                </div>
                                    ...
                                    <div class="process-item">
                                        ...
                                        <div class="process-inner">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="icon"><i class="flaticon-restaurant-elements-dish"></i>
                                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fnbtime-laravel\fnbtime\resources\views/client/index.blade.php ENDPATH**/ ?>